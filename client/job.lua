...
function revivePlayer(closestPlayer)
	...
	ESX.TriggerServerCallback('esx_ambulancejob:getItemAmount', function(quantity)
			...
			if IsPedDeadOrDying(closestPlayerPed, 1) then
				...
				TriggerServerEvent('esx_ambulancejob:redavive', GetPlayerServerId(closestPlayer))
			else
...
function OpenPharmacyMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'pharmacy', {
		...
		align    = 'right',
		elements = {
			{label = _U('pharmacy_take', _U('medikit')), item = 'medikit', type = 'slider', value = 1, min = 1, max = 50},
			{label = _U('pharmacy_take', 'Pan'), item = 'bread', type = 'slider', value = 1, min = 1, max = 100},
			{label = _U('pharmacy_take', 'Agua'), item = 'water', type = 'slider', value = 1, min = 1, max = 100}
	}}, function(data, menu)
