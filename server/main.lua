...
RegisterNetEvent('esx_ambulancejob:redavive')
AddEventHandler('esx_ambulancejob:redavive', function(playerId)
	...
	if xPlayer and xPlayer.job.name == 'ambulance' then
		...
		if xTarget then
			if deadPlayers[playerId] then
				...
				xTarget.triggerEvent('esx_ambulancejob:redavive')
...
ESX.RegisterServerCallback('guy293_getJobsOnline2', function(source, cb)
...
cb(EMSConnected, PoliceConnected, TaxiConnected, MecaConnected)
...
ESX.RegisterCommand('revive', 'admin', function(xPlayer, args, showError)
	args.playerId.triggerEvent('esx_ambulancejob:redavive')
